        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-semibold text-white text-lg">KSRTC Online Concession</span>
            </div>
            <p className="mt-4 text-gray-300 text-sm">
              The KSRTC Online Concession System is a web-based application designed to digitize and streamline 
              the student concession application process for Kerala State Road Transport Corporation (KSRTC).
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li className="flex">
                ...
                <span className="ml-3 text-base text-gray-300">support@ksrtc.kerala.gov.in</span>
              </li>
              <li className="flex">
                <svg className="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="ml-3 text-base text-gray-300">+91 0471-2463799</span>
              </li>
              <li className="flex">
                <svg className="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="ml-3 text-base text-gray-300">Transport Bhavan, Fort, Thiruvananthapuram</span>
              </li>
            </ul>
          </div>
        </div>
